...
### 🗃 2-3 설문 대상자
매년 18,000 명의 재직자(530개의 직종)를 대상으로 설문 조사가 수행되었으며, DACON측에서 직업 라벨이 포함된 데이터(train set) 8,000 ~ 9,000개와 직업 라벨이 포함되지 않은 데이터(test set) 8,000 ~ 9,000개로 나눠서 제공하였다.

## 3. 데이터 전처리
- 총 400 여개의 column들을 분석하여 최종, **123개의 column으로 이뤄진 7,906데이터** 를 사용했습니다.
...
통합 설문 개발 시 3년치 조사의 모든 문항을 다 사용하기엔 공통 문항을 제외해도 400여 개로 그 수가 너무 많으므로 아래의 두가지 분석 방법으로 기반으로 하여 문항 수를 줄였다.
...
- ☞ 최종적으로 122개 문항을 선정, 사용할 컬럼은 knowcode 포함 123개로 정리하였다.
	<p align="center">
...
### 3-4. knowcode(직업코드)별 응답자 수 정리 및 DataFrame 병합
...
- 연도별 설문 대상자가 다르기 때문에, 연도별 응답자 직군의 수도 매년 상이하다.
- 2018~2020년도 모두 "경영·사무·금융·보험직(97개 직군)", "연구직 및 공학 기술직(108개 직군)", "설치·정비·생산직(99개 직군)"에 관련된 직군들이 설문 조사에 가장 많이 응한 것을 알 수 있으며, "농림어업직 (10개 직군)"과 "건설·채굴직(24개 직군)"에 종사하고 있는 재직자분들이 가장 적게 설문조사에 참가한 것으로 확인 되었다. 
...
### 🛰️ 4-2. 직업 대분류별 임금근로자 연봉 (한계값 연봉 1.5억 설정)
![image](https://user-images.githubusercontent.com/68809022/147486889-8471c6a8-22c0-4ca0-a912-73699a24d60f.png)

- 2018~2020년도 모두 "경영·사무·금융·보험직"에 포함되는 97개의 직업들이 다른 직군들에 비해 연봉이 다소 높은 것을 확인 할 수 있다. 
...
- 4-2의 boxplot그래프에서 outlier에 포함된 대상자를 위주로 고소득 직업군을 조사해보았다.
- 2018년도 설문조사에 참가한 응딥자 중, 제품 생산관련 관리자가 연봉 6억으로 가장 높은 임금을 받고 있었으며, 특정 개그맨 및 코미디언과 스포츠 감독 및 코치 또한 많은 임금을 받고 있는 것을 확인하였다.
- 2019년도 설문조사에 참가한 응답자 중, 기업 고위임원들이 연봉 4~5억으로 가장 높은 임금을 받은 것으로 확인되었으며, 그 외에 운동 선수, 의사, 항공기 조종사가 순으로 포함된 것으로 확인되었다.
- 2020년도 설문조사에 참가한 응답자 중, 의사들이 가장 높은 연봉을 받은 것으로 확인되었으며, 의사외의 직군으로는 기업 고위임원이 포함되었다.
